...
type Attributes = Record<string, string> & { classList?: string[] | string, style?: CSSText | Record<string, string> };
 ...
 * }
 */
type Props = Attributes & { on?: Record<string, EventListenerOrEventListenerObject> }
...
function addEventListeners(listeners: Listeners, domel: EventTarget): Listeners {
